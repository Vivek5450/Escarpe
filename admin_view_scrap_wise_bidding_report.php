	...
	<div class="contact">
		<div class="container">
			...
			<div class="contact-bottom">
				...
				<?php
				$bid=$_REQUEST['bid'];
				$res1=mysql_query("select * from bidding_detail where user_id='$bid'");
				if(mysql_num_rows($res1)>0)
				{
					echo "<table class='table table-bordered'>
						...
						while($r1=mysql_fetch_array($res1))
						{
							...
							echo "<td>&#8377; $r2[8] /-</td>";
							echo "<td>&#8377; $r1[4] /-</td>";
							$res9=mysql_query("select * from winner_detail where scrap_id='$r1[2]'");
							if(mysql_num_rows($res9)>0)
							{
								...
								echo "<td style='color:pink;'><b>WINNER NOT DECLARED</b></td>";
							}
							echo "</tr>";
						}
