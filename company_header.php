		...
		<div class="container">
			...
			<div class="navigation">
			 <span class="menu"></span> 
				<ul class="navig">
					<li><a class="active" href="company_upload_scrap.php">Upload Scrap</a><span> </span></li>
					<li><a  href="company_view_scrap.php">View Scrap</a><span> </span></li>
					<li><a href="company_view_scrap_for_selectwinner.php">Select Winner</a><span> </span></li>
					<li><a href="company_complain.php">Complain</a><span> </span></li>
					<li><a href="company_view_complain_status.php">View Complain</a><span> </span></li>
