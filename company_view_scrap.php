					...
					echo "<table class='table table-bordered'>
						...
						while($r1=mysql_fetch_array($res1))
						{
							...
							}else if($r1[11]=="1")
							{
								...
								echo "<td style='color:green;'><a href='company_view_scrap_wise_bid.php?sid=$r1[0]'>VIEW BIDDING</a></td>";
							}else if($r1[11]=="2")
							{
							...
							}else if($r1[11]=="3")
							{
								...
								echo "<td style='color:pink;'><a href='company_view_winner.php?sid=$r1[0]'>VIEW WINNER</a></td>";
							}
							echo "</tr>";
						}
