		...
		<div class="container">
			<div class="contact-top">
				<div class="col-md-12 contact-left heading">
					<CENTER><h2>VIEW SCRAP DETAIL</h2></CENTER>
			...
			<div class="contact-bottom">
				...
				$tdate=date("Y-m-d");
				$res1=mysql_query("select * from scrap_detail where user_id='$userid' and last_bid_date<'$tdate' and status='1'");
				if(mysql_num_rows($res1)>0)
				{
					echo "<table class='table table-bordered'>
						...
						while($r1=mysql_fetch_array($res1))
						{
							...
							echo "<td style='color:green;'><a href='company_select_winner.php?sid=$r1[0]'>SELECT WINNER</a></td>";
